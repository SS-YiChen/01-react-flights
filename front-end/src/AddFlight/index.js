...
const AddFlight = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post('http://localhost:8085/add', 
...
<form className="well form-horizontal" id="update_form" onSubmit={handleSubmit}>
    <fieldset>
        ...
        <legend><center><h2><b>Add Form</b></h2></center></legend>
        ...
        <div className="form-group">
            ...
            <div className="col-md-4">
                <button type="submit" className="btn btn-success" >Add <span className="glyphicon glyphicon-plus"></span></button>
